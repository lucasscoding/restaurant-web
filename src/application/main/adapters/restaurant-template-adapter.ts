...
import {RestaurantFactory} from '@/application/main/factories/restaurant-factory';
...
export abstract class AbstractRestaurantTemplateAdapter extends React.Component<
  Props,
  State
> {
